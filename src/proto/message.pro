/* message.c */
int msg __ARGS((char_u *s, async_context *_async_context));
int verb_msg __ARGS((char_u *s));
int msg_attr __ARGS((char_u *s, int attr, async_context *_async_context));
int msg_attr_keep __ARGS((char_u *s, int attr, int keep, async_context *_async_context));
...
void show_sb_text __ARGS((async_context *_async_context));
...
int msg_end __ARGS((async_context *_async_context));
