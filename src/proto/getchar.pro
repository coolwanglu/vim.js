...
int DEFINE_ASYNC_CALLBACK __ARGS((int vgetc__cb1));
int DEFINE_ASYNC_CALLBACK __ARGS((int vgetc__cb2));
int DEFINE_ASYNC_CALLBACK __ARGS((int vgetc__cb3));
int DEFINE_ASYNC_CALLBACK __ARGS((int vgetc__cb4));
int DEFINE_ASYNC_CALLBACK __ARGS((int vgetc__cb5));
int DEFINE_ASYNC_CALLBACK __ARGS((int vgetc__cb6));
int safe_vgetc __ARGS((async_context *_async_context));
int DEFINE_ASYNC_CALLBACK __ARGS((int safe_vgetc__cb1));
int plain_vgetc __ARGS((async_context *_async_context));
int DEFINE_ASYNC_CALLBACK __ARGS((int plain_vgetc__cb1));
...
int DEFINE_ASYNC_CALLBACK __ARGS((int vgetorpeek__cb1));
int DEFINE_ASYNC_CALLBACK __ARGS((int vgetorpeek__cb2));
int inchar __ARGS((char_u *buf, int maxlen, long wait_time, int tb_change_cnt, async_context *_async_context));
int DEFINE_ASYNC_CALLBACK __ARGS((int inchar__cb1));
