...
int buflist_getfile __ARGS((int n, linenr_T lnum, int options, int forceit, async_context *_async_context));
...
void do_modelines __ARGS((int flags, async_context *_async_context));
...
int buf_contents_changed __ARGS((buf_T *buf, async_context *_async_context));
