...
int do_in_runtimepath __ARGS((char_u *name, int all, void (*callback)(char_u *fname, void *ck, async_context *_async_context), void *cookie, async_context *_async_context));
