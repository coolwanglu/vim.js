/* memline.c */
int ml_open __ARGS((buf_T *buf, async_context *_async_context));
...
void ml_open_files __ARGS((async_context *_async_context));
...
char_u *ml_get_curline __ARGS((async_context *_async_context));
char_u *ml_get_cursor __ARGS((async_context *_async_context));
