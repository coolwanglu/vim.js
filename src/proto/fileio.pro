...
int readfile __ARGS((char_u *fname, char_u *sfname, linenr_T from, linenr_T lines_to_skip, linenr_T lines_to_read, exarg_T *eap, int flags, async_context *_async_context));
...
int buf_write __ARGS((buf_T *buf, char_u *fname, char_u *sfname, linenr_T start, linenr_T end, exarg_T *eap, int append, int forceit, int reset_changed, int filtering, async_context *_async_context));
...
int check_timestamps __ARGS((int focus, async_context *_async_context));
int buf_check_timestamp __ARGS((buf_T *buf, int focus, async_context *_async_context));
void buf_reload __ARGS((buf_T *buf, int orig_mode, async_context *_async_context));
...
int match_file_list __ARGS((char_u *list, char_u *sfname, char_u *ffname, async_context *_async_context));
char_u *file_pat_to_reg_pat __ARGS((char_u *pat, char_u *pat_end, char *allow_dirs, int no_bslash, async_context *_async_context));
