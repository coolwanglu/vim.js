...
pos_T *getmark_buf __ARGS((buf_T *buf, int c, int changefile, async_context *_async_context));
pos_T *getmark __ARGS((int c, int changefile, async_context *_async_context));
...
void ex_delmarks __ARGS((exarg_T *eap, async_context *_async_context));
