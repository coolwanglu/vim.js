 ...
 */
    int
getfile(fnum, ffname, sfname, setpm, lnum, forceit ASYNC_ARG)
    int		fnum;
    char_u	*ffname;
    char_u	*sfname;
    int		setpm;
 ...
 */
    int
do_ecmd(fnum, ffname, sfname, eap, newlnum, flags, oldwin ASYNC_ARG)
    int		fnum;
    char_u	*ffname;
    char_u	*sfname;
...
skip:
			...
			|| regmatch.startpos[0].lnum > 0)
		{
			...
			if (nmatch_tl > 0)
			{
				...
				ml_delete(lnum, (int)FALSE ASYNC_ARG);
